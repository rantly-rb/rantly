...
New development will occur in this fork. The transition plan is as follows:

#1 Investigate and move open issues.
#2 Move over any closed issues that have relevant discourse.
#3 Fix open issues.
#4 Push new gem version after testing functionality.
#5 Continue new development; Changes will be pushed back upstream to "hayeah/rantly":https://github.com/hayeah/rantly over the course of the next month.
