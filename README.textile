...
The parameter of <code>shrink()</code> and its second return value are used with collections like <code>Array</code> and <code>Hash</code> to remember next position when exploring the many ways to reduce the collection.
